module PPU_to_RLC_Packer (
    ...
    // RLC vector input stream: {v0, v1, v2, v3, v4, v5, v6}
    ...
    // Place the earliest scalar in the most-significant byte, matching the
    // encoder comment: {v0, v1, v2, v3, v4, v5, v6}.
    always_comb begin
        pack_with_current = pack_reg;
        case (pack_count)
            3'd0: pack_with_current[55:48] = scalar_data_i;
            3'd1: pack_with_current[47:40] = scalar_data_i;
            3'd2: pack_with_current[39:32] = scalar_data_i;
            3'd3: pack_with_current[31:24] = scalar_data_i;
            3'd4: pack_with_current[23:16] = scalar_data_i;
            3'd5: pack_with_current[15:8]  = scalar_data_i;
            3'd6: pack_with_current[7:0]   = scalar_data_i;
        ...
        if (rst) begin
            ...
            if (scalar_fire) begin
                if ((pack_count == 3'd6) || scalar_last_i) begin
                    // Full vector, or final partial vector. Unused bytes remain
                    // zero because pack_reg is cleared after every emission.
